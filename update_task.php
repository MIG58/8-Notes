...
<head>
    ...
    <link rel="icon" href="./Iconsicon1.png" type="image/png">
    <title>8 Notes</title>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
            data-bs-whatever="@getbootstrap" href="index.php">Add Notes
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Notes Here</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="update_process.php" method="POST"> <!-- Form Data Sent -->
                            <div class="mb-2">
                                <label for="title" class="form-label"><b>Title</b></label>
                                <input type="text" class="form-control" id="title" name="t_name" value="<?php echo $row['task_name'];?>" required>
                                <br>
                            </div>
                            <div class="mb-3">
                                <label for="desc" class="form-label"><b>Description</b></label>
                                <textarea class="form-control" id="desce" name="t_desc" rows="5"><?php echo $row['task_description'];?></textarea>
                              <!-- Hidden ID sending -->
    ...
    <script>
        // Add this script at the end of your body to trigger the modal on page load
...
<div class="container">
  <footer class="py-3 my-4">
    ...
    <p class="text-center text-muted">&copy; 2023-2024 <b>8 Notes </b> Company, Inc</p>
  </footer>
</div>
